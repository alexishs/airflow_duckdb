...
# RUN usermod -u 1001 -g 0 airflow && chown 1001:0 -R /home/airflow && chown 1001:0 -R /opt/airflow
...
RUN pip install --no-cache-dir asyncpg psycopg2-binary pandas pyarrow requests gtfs-realtime-bindings